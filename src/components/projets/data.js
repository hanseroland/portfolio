...
export const data = [
   ...
   
    {
        ...
        name:"Weather",
        image:Img3,
        description:"Il s'agit d'une application  de Météo utilisant l'API de OpenWeatherMap pour la recupération des données",
        technologies:[
    ...
    },
    {
        ...
        "il permet de geolocaliser la pharmacie de garde la plus proche qui possède le médicament recherché",
        technologies:[
             {id:1,name:"React Native"},
             {id:2,name:"PHP"},
             {id:3,name:"MySql"},
...

    {
        ...
        name:"CRM Fonq Médi+",
        image:Img12,
        description:"FONQ MEDI + est un CRM de gestion hospitalière. Il a pour but d'aider les structures hospitalières à manager leur structure en passant par la digitalisation des tâche quotidienne comme : La prise de rendevez-vous, la gestion de la pharmacie, gestion des chambres, gestion des fiches patients, gestion de la comptabilité, gestion des ordonnances, gestion du personnel, facturation",
        technologies:[
            {id:1,name:"React"},
            {id:2,name:"Redux"},
            {id:3,name:"PHP"},
 ...
 
    {
        ...
        name:"Cabinet Carree",
        image:Img7,
        description:"Le Cabinet Carree est un cabinet de conseil spécialisé dans l'accompagnement des TPEs/PMEs avec pour vision de formaliser le secteur informel.",
        technologies:[
            {id:1,name:"Wordpress"},
        ],
        github:"",
    ...
    
    {
        ...
        description:"Bravo Sénégal, comme étant la première plateforme de distribution des équipements de marque Apple à des entreprises en paiement écheloné",
        github:"",
    ...
    },
    {
        ...
        description:"La clinique Pasteur est l’une des premières clinique privée de haut niveau au Sénégal et était sise sur l’avenue Pasteur non loin de l’Assemblée Nationale",
        github:"",
